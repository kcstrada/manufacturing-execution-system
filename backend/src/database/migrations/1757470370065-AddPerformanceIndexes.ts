...
export class AddPerformanceIndexes1757470370065 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_production_orders_covering";`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_production_orders_product_id";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_work_orders_product_id";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_quality_inspections_measurements";`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_activity_logs_user_date";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_activity_logs_entity_date";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_workers_department_active";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_maintenance_records_history";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_equipment_next_maintenance";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_customer_orders_customer_status";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_customer_orders_status_date";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_quality_inspections_product_type";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_quality_inspections_date_result";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_task_dependencies_depends_on";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_task_dependencies_task";`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_inventory_available_quantity";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_work_orders_completion";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_work_orders_assigned_status";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_work_orders_production_sequence";`);
        
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_production_orders_date_range";`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_production_orders_status_priority";`);
    }
