...
export class UpdateQualityMetricDto extends PartialType(
  CreateQualityMetricDto,
) {}
...
export class UpdateQualityControlPlanDto extends PartialType(
  CreateQualityControlPlanDto,
) {}

export class UpdateNonConformanceReportDto extends PartialType(
  CreateNonConformanceReportDto,
) {}
